      ...
      <POSTypePage
        ...
        content={
          <div className="prose max-w-none">
            <p>Mobil POS cihazları, işletmelerin hareket halindeyken ödeme almalarını sağlayan taşınabilir cihazlardır. Bu cihazlar, kablosuz internet veya mobil veri bağlantısı üzerinden çalışır ve kredi kartı ödemelerini güvenli bir şekilde işler.</p>
            
            <h3>Mobil POS Avantajları</h3>
            <ul>
              <li>Hareket halindeyken ödeme alma imkanı</li>
              ...
              <li>Detaylı satış raporlaması</li>
              <li>Güvenli işlem altyapısı</li>
            </ul>
          </div>
        }
      />
