  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Ücretsiz POS komisyon oranları hesaplama aracımız ile işlem tutarı ve komisyon oranına göre ödeyeceğiniz tutarı kolayca hesaplayın." />
