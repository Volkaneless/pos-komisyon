  ...
  return (
    <Tabs defaultValue="explanation" className="w-full">
      <div className="overflow-x-auto pb-2">
        <TabsList className="w-full justify-start border-b rounded-none bg-transparent space-x-4 md:space-x-8">
          <TabsTrigger 
            value="explanation" 
            className="data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:bg-transparent rounded-none px-2 md:px-0 whitespace-nowrap" 
      ...
      <TabsContent value="explanation" id="explanation" className="mt-6">
      ...
      <TabsContent value="commissions" id="commissions" className="mt-6">
        <Card className="border-none shadow-none">
      ...
      <TabsContent value="features" id="features" className="mt-6">
        <Card className="border-none shadow-none">
      ...
      <TabsContent value="customer-service" id="customer-service" className="mt-6">
        <Card className="border-none shadow-none">
          <div className="space-y-6">
      ...
      <TabsContent value="support" id="support" className="mt-6">
        <Card className="border-none shadow-none">
          <div className="space-y-6">
