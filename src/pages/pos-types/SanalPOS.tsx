...
import { Filter, X, Search, TrendingUp, Building } from "lucide-react";
...
const SanalPOS = () => {
  ...
  const applyFilters = (providers: string[], types: string[], search: string) => {
            ...
            <div className="max-w-4xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div className="bg-primary/10 text-primary px-3 py-2 rounded-lg text-center">
                  ...
                  <div className="text-xs">Sanal POS</div>
                </div>
