...
const CalculationResults = () => {
  const { calculations, getCommissionRate, buyPrice, cargoPrice, sellerCargo } = useHepsiburada();

  return (
    <Card className="p-6 rounded-xl shadow-lg bg-white">
      <h3 className="text-xl font-semibold text-blue-600 mb-2">Hesaplama Sonucu</h3>
      {!calculations ? (
