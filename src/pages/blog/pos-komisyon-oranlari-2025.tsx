...
const POSKomisyonOranlari2025 = () => {
  return (
    <>
      <Helmet>
        <title>2025 POS Komisyon Oranları Karşılaştırması | POS Compare</title>
        <meta 
          name="description" 
      ...
      <div className="container mx-auto px-4 pt-24 pb-16">
        <article className="prose prose-lg max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8">2025 POS Komisyon Oranları</h1>
          
          <div className="text-sm text-gray-500 mb-8">
            Güncelleme Tarihi: 1 Mart 2025
          </div>

          <h2 className="text-2xl font-semibold mt-8 mb-4">2025 Yılı POS Komisyon Oranları</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">POS Komisyon Oranlarını Etkileyen Faktörler</h2>
          <p>
...
export default POSKomisyonOranlari2025;
